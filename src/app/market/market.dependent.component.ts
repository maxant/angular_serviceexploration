...
export class MarketDependentComponent implements OnInit {
  ...
  ngOnInit() {
    // retrieve resolved data from the route. see routing which defines a resolver.
    // this init code is only called when the promise from the resolver is completed.
